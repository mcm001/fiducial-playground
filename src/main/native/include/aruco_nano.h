...
*/
#ifndef FIDUCIAL_PLAYGROUND_SRC_MAIN_NATIVE_INCLUDE_ARUCO_NANO_H_
#define FIDUCIAL_PLAYGROUND_SRC_MAIN_NATIVE_INCLUDE_ARUCO_NANO_H_
#include <array>
...
MarkerDetector::internalDetect(const cv::Mat &inputMat,
  ...
  for (unsigned int contourIdx = 0; contourIdx < foundContours.size();
       contourIdx++) {
    if (50 > int(foundContours[contourIdx].size()))
      continue;
...
#endif // FIDUCIAL_PLAYGROUND_SRC_MAIN_NATIVE_INCLUDE_ARUCO_NANO_H_
